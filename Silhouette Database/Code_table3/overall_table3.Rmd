...
table_data <- data.frame(
  Comparisons = c("Apples vs. Hearts", "Apples vs. Children", "Hearts vs. Children",
                  "Apples vs. Apples", "Hearts vs. Hearts", "Children vs. Children"),
...
table_data[4,2] = mean(p_value_final)
...
for (i in 1:100) {
 ...
 table_data[4,3] = mean(p_value_final)
